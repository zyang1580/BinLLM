...
def run_a_trail(train_config,log_file=None, save_mode=False,save_file=None,need_train=True,warm_or_cold=None,need_uauc=False):
    ...
    model.beta_init(train_config['beta'])
    ...
    for lr in lr_:
        for wd in dw_:
            for embedding_size in embedding_size_:
                ...
                # save_path = "/data/cf4llm/0130hashGNN-ml-32lr-0.01wd0.001.pth" #"/data/cf4llm/0130hashGNN-ml-128lr-0.001wd0.001.pth"
                save_path = "/data1/cf4reclog-cc/hash/0130hashGNN-ml-32lr-0.01wd0.001.pth"
